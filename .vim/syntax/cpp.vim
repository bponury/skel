...
syn keyword	cType		u_int32_t int32_t u_int16_t int16_t u_int8_t int8_t u_int64_t int64_t
syn keyword	cType		off_t timeval pthread_t sem_t pthread_mutex_t
syn keyword	cType		signed unsigned float double
syn keyword	cType		u_char u_short u_int u_long quad_t u_quad_t fsid_t loff_t ino_t ino_t ino64_t dev_t gid_t mode_t nlink_t uid_t off_t off_t off64_t pid_t id_t ssize_t daddr_t caddr_t key_t useconds_t suseconds_t long int ulong short int ushort int uint  int16_t  int int64_t long long int int64_t u_int8_t int u_int16_t u_int32_t long int u_int64_t
...
syn keyword	cStructure	struct union enum typedef class
