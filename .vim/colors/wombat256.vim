...
" General colors
hi Cursor       ctermfg=0    ctermbg=NONE     cterm=none
...
hi Constant     ctermfg=178     cterm=none
hi String       ctermfg=41 cterm=none
hi Identifier   ctermfg=185   cterm=none
hi Function     ctermfg=185     cterm=none
hi Type         ctermfg=210    cterm=none
...
hi Special      ctermfg=118  cterm=none
